...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-8 col-sm-offset-2 margin-bottom-60">
      ...
      <input type="text" class="text_holder" name="userrealname" placeholder="Enter user's real name" id="userrealname" value="{$userData['name']}">

        <input type="text" class="text_holder" name="username" placeholder="Enter user email address as username" id="username" value="{$userData['username']}">
        ...
        <input type="text" class="text_holder" name="nic" placeholder="Enter user NIC no" id="nic" value="{$userData['nic']}">
        <input type="text" class="text_holder" name="address" placeholder="Enter user address" id="address" value="{$userData['address']}">
        <input type="text" class="text_holder" name="tel1" placeholder="Enter user primary telephone number" id="tel1" value="{$userData['tel1']}">
        <input type="text" class="text_holder" name="tel2" placeholder="Enter user secondary telephone number" id="tel2" value="{$userData['tel2']}">
